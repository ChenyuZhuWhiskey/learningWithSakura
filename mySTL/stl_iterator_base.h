...
#ifndef MY_STL_STL_ITERATOR_BASE_H
#define MY_STL_STL_ITERATOR_BASE_H
...
//partial spetialization for pointer type:
template<class _Tp>
...
#define __DISTANCE_TYPE(__i) __distance_category(__i);
...
#endif //MY_STL_STL_ITERATOR_BASE_H